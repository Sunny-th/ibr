// Core premium rates (unchanged)
const premiumRates = {
  'Emerald': { '0-17': 959, '18-24': 1490, '25-29': 1851, '30-34': 1992, '35-39': 2175, '40-44': 2527, '45-49': 2886, '50-54': 3230, '55-59': 4218, '60-64': 5323, '65-69': 7127, '70-74': 9321, '75-79': 10954, '80+': 12139 },
  'Sapphire': { '0-17': 1059, '18-24': 1645, '25-29': 2046, '30-34': 2200, '35-39': 2405, '40-44': 2793, '45-49': 3189, '50-54': 3569, '55-59': 4662, '60-64': 5883, '65-69': 8076, '70-74': 10758, '75-79': 12755, '80+': 14202 },
  'Ruby': { '0-17': 1721, '18-24': 2573, '25-29': 3170, '30-34': 3346, '35-39': 3739, '40-44': 4275, '45-49': 4925, '50-54': 5480, '55-59': 6834, '60-64': 8710, '65-69': 11646, '70-74': 15519, '75-79': 18342, '80+': 20424 },
  'Jade': { '0-17': 2271, '18-24': 3283, '25-29': 3939, '30-34': 4276, '35-39': 4679, '40-44': 5376, '45-49': 5991, '50-54': 6813, '55-59': 8557, '60-64': 11340, '65-69': 15164, '70-74': 20109, '75-79': 23659, '80+': 26341 },
  'Diamond': { '0-17': 2493, '18-24': 3604, '25-29': 4325, '30-34': 4693, '35-39': 5136, '40-44': 5901, '45-49': 6578, '50-54': 7478, '55-59': 9393, '60-64': 12449, '65-69': 16645, '70-74': 22074, '75-79': 25971, '80+': 28917 }
};

// Country-specific zone multipliers
const countryMultipliers = {
  'Thailand': 1.0,  // No change to base rate
  'Indonesia': 1.15,  // 15% increase
  'Hong Kong': 2.0  // 100% increase
};
...
const calculatePremium = () => {
  ...
  const countryOfResidence = document.getElementById("countryOfResidence").value; // Use this for country multiplier
  ...
  const countryMultiplier = countryMultipliers[countryOfResidence] || 1.0;  // Default to 1.0 if no match
  let adjustedPremium = basePremium * countryMultiplier;
  breakdownSteps.push(`Country of residence (${countryOfResidence}) adjustment: ${((countryMultiplier - 1) * 100).toFixed(0)}% adjustment (Multiplied by ${countryMultiplier})`);

  // Now apply other adjustments like area of cover, copay, and deductibles
  ...
  adjustedPremium *= areaMultiplier;
  breakdownSteps.push(`Area of cover (${areaOfCover}) adjustment: ${((areaMultiplier - 1) * 100).toFixed(0)}% adjustment`);
  ...
  // Display final premium and breakdown
  document.getElementById("quote").innerHTML = `Estimated Premium: $${adjustedPremium.toFixed(2)}`;
